...
plt.plot(X1_data,Y1_data,c="red",label="f(x)=e^(-x^2): -{}<x<0".format(p))
plt.plot(X2_data,Y2_data,c="red",label="f(x)=sqrt(1-x^2): 0<x<p".format(p))
