...
degree = int(input("Until which Legendre Polinomial? "))
...
for n in range(1,degree+1):
    ...
    #print("\n Derivative polinomial matrix of degree {}, which order is {}".format(n,n))
    ...
    plt.grid()
    plt.title("Legendre Polinomials of degrees less than {}".format(n))
    plt.savefig("LegendrePolinomialUntil_{}.png".format(n))
